...
SOURCES += ButterComp.cpp BrassRider.cpp Point.cpp Gatelope.cpp PodcastDeluxe.cpp Podcast.cpp
SOURCES += Swell.cpp Surge.cpp SurgeTide.cpp
...
AIRWINDOWS_SOURCES += PointProc.cpp GatelopeProc.cpp PodcastDeluxeProc.cpp PodcastProc.cpp
AIRWINDOWS_SOURCES += SwellProc.cpp SurgeProc.cpp SurgeTideProc.cpp
