...
SOURCES += Pressure4Plugin.cpp curvePlugin.cpp ButterComp2Plugin.cpp Pop2Plugin.cpp VariMu.cpp
SOURCES += PurestSquish.cpp
SOURCES += MessageQueue.cpp Settings.cpp SettingsParser.cpp
AIRWINDOWS_DIR := from-airwindows
AIRWINDOWS_SOURCES += Pressure4Proc.cpp curveProc.cpp ButterComp2Proc.cpp Pop2Proc.cpp VariMuProc.cpp
AIRWINDOWS_SOURCES += PurestSquishProc.cpp
